...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Aplicacion web de gestion de olivar y campo. Monorepo con frontend en React y API REST en Express con Prisma, autenticacion JWT, despliegue con Docker y asistente IA integrado para ayudar al usuario.',
    technologies: ['React', 'Express', 'Prisma', 'JWT', 'Docker', 'IA'],
    demoUrls: ['https://olivas-app-web.vercel.app/login'],
    repoUrl: 'https://github.com/davidarrcal/Olivas-app',
  },
  {
    title: 'Gestión Restaurante',
    description: 'Aplicacion web de gestion de restaurante con modulo de informes y analisis de datos del negocio. Monorepo con frontend en Next.js, API en NestJS y base de datos con Prisma. Autenticacion JWT, despliegue en Vercel y asistente IA integrado para ayudar al usuario.',
    technologies: ['Next.js', 'React', 'NestJS', 'Prisma', 'TypeScript', 'Tailwind CSS', 'JWT', 'IA'],
    demoUrls: ['https://gesti-n-restaurante-web.vercel.app/login'],
